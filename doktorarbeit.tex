...
%  \input{chapter/introduction.tex}
  ...
  \input{chapters/intro/body.tex}

  \cleardoublepage
  \thispagestyle{empty}
  \input{chapters/theory/body.tex}
  
  \cleardoublepage
  \thispagestyle{empty}
  \input{chapters/ccsn/body.tex}

  \cleardoublepage
  \thispagestyle{empty}
  \input{chapters/numerics/body.tex}
  \cleardoublepage
  \thispagestyle{empty}
  \input{chapters/signal/body.tex}


  \cleardoublepage
  \thispagestyle{empty}
  \input{chapters/paper1/body.tex}

  \cleardoublepage
  \thispagestyle{empty}
  \input{chapters/paper2/body.tex}

  \cleardoublepage
  \thispagestyle{empty}
  \input{chapters/sum/body.tex}
  ...
  \phantomsection
  \thispagestyle{empty}
  \input{listofconv.tex}

  \cleardoublepage
  \thispagestyle{empty}
  \phantomsection
  \thispagestyle{empty}
  \input{listofabvr.tex}

    \cleardoublepage
  \thispagestyle{empty}
  \phantomsection
  \input{chapters/ack/body.tex}
