...
There are several ways segment the signal, the method used in this thesis 
...
% If the time-signal only consists of ossilations at frequencies that are
% multiples of the sampling frequency we can accuratly represent it with an DFT. However,
% if a signal contains frequency components that are not integer multiples of frequency 
% what is know as spectral leckage. The problem is what happens to the spectral energy 
